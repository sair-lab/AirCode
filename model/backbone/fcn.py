...
class VGGNet(VGG):
    def __init__(self, pretrained=True, model='vgg16', requires_grad=True, remove_fc=True, show_params=False, input_channel=3):
        super(VGGNet,self).__init__(make_layers(cfg[model], input_channel=input_channel))
